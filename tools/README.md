...
|---|---|---|---|
| `build_okf.py` | `api-docs/`, `handwritten/` | `bundle/` (deleted and recreated) | Generates the OKF bundle. Prints `endpoints=… groups=… errors=… sdk=…` on success and `WARN` lines when markdown and OpenAPI disagree. |
